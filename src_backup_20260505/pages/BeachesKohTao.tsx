...
const beaches = [
  {
    name: "Jungutbatu Beach",
    subtitle: "Noord & Zuid",
    image: "/images/maehad.jpg",
    description: "Often overlooked due to their proximity to the pier, both north and south sections of Jungutbatu beach offer a great place to spend a day. The south section stretches from Coconut Monkey coffee shop all the way to Sensi Paradise resort — clean, white and sandy. Near the resort is a 60-year-old shipwreck, a great snorkeling location with its own marine ecosystem. The north side features a safe swimming area cordoned off from boat traffic, kept in pristine condition and cleaned daily. A very popular spot to watch Nusa Lembongan's famous sunsets.",
    location: "Westkust",
    tags: ["Snorkelen", "Zwemmen", "Zonsondergang", "Gezinsvriendelijk"],
    tip: "Ga naar Breeze Nusa Lembongan voor lunch en strandbedjes — perfect voor zonsondergang.",
  },
  {
    name: "Sai Nuan Beach",
    subtitle: "Verborgen parel",
    image: "/images/sanjuan.jpg",
    description: "A hidden gem and throwback to the days when the first backpackers arrived on Nusa Lembongan. Sai Nuan is actually two scenic beaches separated by a rocky outcrop. The first has a grass area with a tree swing and hammocks between palm trees. The small Sai Thong resort of wooden Thai-style bungalows adds to the relaxed, peaceful atmosphere. On a clear day expect white sand, coconut palms, and a clear warm turquoise sea. One of the least crowded beaches on the island.",
    location: "Zuidwest",
    tags: ["Afgelegen", "Rustig", "Snorkelen", "Hangmatten"],
    tip: "Loop vanaf Jungutbatu achter Sensi Paradise langs — ongeveer 25 minuten. Volg de bordjes onderweg.",
  },
  {
    name: "June Juea Beach",
    subtitle: "Meest afgelegen",
    image: "/images/JunejueaBeach.jpg",
    description: "Possibly the most remote beach on Nusa Lembongan and certainly one of the smallest, June Juea is one of the most picturesque and secluded places to watch the sunset. Located on the south west side of the island, you can reach it by continuing the coastal walk from Sai Nuan, or walking from Mushroom Bay. The bay is made up of small areas of sand between large rocks and trees that provide natural shade. Perfect for getting away from it all.",
    location: "Zuidwest",
  ...
  },
  {
    ...
    description: "Another small secluded beach, Freedom beach is probably the most popular small beach on Nusa Lembongan. Located on the south side, it's best reached by scooter — about 10 minutes from Jungutbatu. The 100 baht entrance fee gives access to John Suwan Viewpoint, Taa Toh beach, and Freedom Beach. Beautiful white sandy beach with shade from Pemphis Acidula trees with hammocks, a shallow reef for snorkeling, and a beachside restaurant overlooking Mushroom Bay bay.",
    location: "Zuidkust",
  ...
  },
  {
    ...
    description: "Situated on the east side of Nusa Lembongan, Tanote Bay is easily accessible via the concrete road on a scooter. For early risers it's perfect for watching the sunrise facing east. Surrounded by steep jungle-covered hills, the beach stretches across the bay offering room for activities, swimming, snorkeling, and sunbathing. A large granite rock just offshore is the best rock jumping location on Nusa Lembongan. Excellent marine life makes it a popular snorkeling and occasional diving spot.",
    location: "Oostkust",
  ...
  {
    name: "Blue Corner Beach",
    subtitle: "Instagram-paradijs",
    image: "/images/aowluk.jpg",
    description: "This beautiful beach sits in a stunning bay on the south east side of Nusa Lembongan — one of the most picturesque bays in the entire Samui Archipelago. On a clear day you have a stunning backdrop of Koh Phangan with the iconic SD Point in the foreground, less than 1km by kayak. A 100 baht entrance fee includes fresh water and a sun lounger with umbrella. Colourful coral reef lines both sides of the bay, and the sheltered middle is perfect for swimming.",
    location: "Zuidoost",
  ...
  },
  {
    ...
    description: "World-famous Jungutbatu Beach is the busiest and longest beach on Nusa Lembongan at almost 2 kilometres. The main tourist hub, Jungutbatu has bars, restaurants, and resorts with soft white sand and plenty of shade. Activities include tree swings, paddleboarding, kayaking, beach volleyball, swimming, and snorkeling. Walk the full length along the path behind beachfront properties past shops and resort entrances. Popular sunset bars with music make evenings unforgettable on the west-facing shore.",
    location: "Westkust",
    tags: ["Bars & restaurants", "Paddleboarden", "Kajakken", "Zonsondergang", "Nachtleven"],
    tip: "Loop van het ene uiteinde naar het andere — zo ontdek je eenvoudig de leukste plekjes van Jungutbatu.",
  },
  {
    name: "Koh Nang Yuan",
    subtitle: "Het iconische eiland — 800 m uit de kust",
    image: "/images/japanandwins.jpg",
    description: "Koh Nang Yuan is a separate island located approximately 800 metres off the north west coast of Nusa Lembongan, accessible by long-tail boat. Probably the most photographed beach in Indonesia — a unique inter-connected sandbar connecting three land masses. With a stunning Viewpoint to climb and snorkeling one of Indonesia's most diverse coral reefs, it's on every visitor's bucket list. At low tide the sandbar connects the land masses with soft white sand and sun loungers.",
    location: "Noordwest (apart eiland)",
    tags: ["Iconisch", "Uitzichtpunt", "Snorkelen", "Koraalrif", "Fotografie"],
    tip: "Boek een halve of hele dag snorkeltour, of huur een lokale longtailboot vanaf de westkant van Nusa Lembongan.",
  },
];
...
const BeachesKohTao = () => {
  ...
  const content = {
    nl: {
      heroTitle: 'Stranden van Nusa Lembongan',
      heroText: 'Nusa Lembongan is gezegend met prachtige natuur: groene jungle, baaien met palmen en tropisch turquoise water aan witte zandstranden.',
      introTitle: 'Prachtige stranden op Nusa Lembongan – Ontspan & geniet',
      ...
      tipLabel: '💡 Tip:',
      ctaTitle: 'Ontdek Nusa Lembongan buiten de stranden',
      ...
      ctaMarineLife: 'Mariene leven Nusa Lembongan',
      ctaBook: 'Boek een trip',
    },
    en: {
      heroTitle: 'Beaches of Nusa Lembongan',
      heroText: 'Nusa Lembongan is blessed with stunning nature: lush jungle, palm-lined bays, and tropical turquoise water along white sandy beaches.',
      introTitle: 'Beautiful beaches on Nusa Lembongan – Relax & enjoy',
      ...
      tipLabel: '💡 Tip:',
      ctaTitle: 'Discover Nusa Lembongan beyond the beaches',
      ...
      ctaMarineLife: 'Nusa Lembongan marine life',
      ctaBook: 'Book a trip',
    },
  };
  ...
  const toEnglishTip = (tip: string) => {
    const map: Record<string, string> = {
      'Ga naar Breeze Nusa Lembongan voor lunch en strandbedjes — perfect voor zonsondergang.': 'Head to Breeze Nusa Lembongan for lunch and beach loungers — perfect for sunset.',
      'Loop vanaf Jungutbatu achter Sensi Paradise langs — ongeveer 25 minuten. Volg de bordjes onderweg.': 'Walk from Jungutbatu past Sensi Paradise — about 25 minutes. Follow the signs along the way.',
      ...
      'Loop van het ene uiteinde naar het andere — zo ontdek je eenvoudig de leukste plekjes van Jungutbatu.': 'Walk from one end to the other to easily discover Jungutbatu’s best spots.',
      'Boek een halve of hele dag snorkeltour, of huur een lokale longtailboot vanaf de westkant van Nusa Lembongan.': 'Book a half-day or full-day snorkeling trip, or hire a local longtail boat from Nusa Lembongan’s west side.',
    };
    return map[tip] || tip;
  };
