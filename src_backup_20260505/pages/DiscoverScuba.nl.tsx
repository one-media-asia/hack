  ...
  return (
    <CoursePageTemplate
      ...
      fallbackContent={{
        ...
        hero_subtitle: 'Ervaar hoe het is om onder water te ademen, zonder brevet nodig. Dit beginnersprogramma is de perfecte eerste duikervaring op Nusa Lembongan.',
