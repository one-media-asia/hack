...
const PAGE_DEFINITIONS: Record<string, ContentItem[]> = {
  'home': [
    ...
    { section_key: 'about_map_alt', content_value: 'Map of Nusa Lembongan and dive sites', content_type: 'text', label: 'About Map Alt Text' },
    ...
    { section_key: 'about_paragraph_1', content_value: 'Nusa Lembongan is a top destination for diving holidays in Bali, Indonesia. It is ideal for completing PADI dive certifications, for both beginners and experienced divers.', content_type: 'textarea', label: 'About Paragraph 1' },
    { section_key: 'about_paragraph_2', content_value: 'Lifetime certifications valid worldwide, at a surprisingly low price. Earn your PADI diving certification here for 11500 baht, now including 4 nights accommodation in the course price.', content_type: 'textarea', label: 'About Paragraph 2' },
    { section_key: 'about_note', content_value: 'Free accommodation with our courses can only be guaranteed if booked 7 days in advance. If our accommodation is not available, we will assist you with staying in one of our partner resorts.', content_type: 'textarea', label: 'About Note' },
    { section_key: 'courses_section_title', content_value: 'Our Diving Courses', content_type: 'text', label: 'Courses Section Title' },
    { section_key: 'courses_section_subtitle', content_value: 'Choose from beginner experiences to professional dive training on Nusa Lembongan.', content_type: 'textarea', label: 'Courses Section Subtitle' },
    ...
    { section_key: 'gallery_subtitle', content_value: 'Experience the breathtaking beauty of Nusa Lembongan\u2019s underwater world in our photo gallery', content_type: 'textarea', label: 'Gallery Subtitle' },
    ...
    { section_key: 'course_open_water_price', content_value: 'IDR 4,500,000', content_type: 'text', label: 'Open Water Card Price' },
    ...
    { section_key: 'course_advanced_price', content_value: 'IDR 3,700,000', content_type: 'text', label: 'Advanced Card Price' },
    ...
    { section_key: 'course_efr_price', content_value: 'IDR 1,350,000', content_type: 'text', label: 'EFR Card Price' },
    ...
    { section_key: 'course_rescue_price', content_value: 'IDR 4,000,000', content_type: 'text', label: 'Rescue Card Price' },
    ...
    { section_key: 'course_divemaster_price', content_value: 'IDR 16,000,000', content_type: 'text', label: 'Divemaster Card Price' },
    ...
    { section_key: 'course_instructor_price', content_value: 'IDR 27,000,000', content_type: 'text', label: 'Instructor Card Price' },
    ...
    { section_key: 'course_discover_scuba_price', content_value: 'IDR 950,000', content_type: 'text', label: 'Discover Scuba Card Price' },
    ...
    { section_key: 'course_discover_scuba_deluxe_price', content_value: 'IDR 1,950,000', content_type: 'text', label: 'Discover Scuba Deluxe Card Price' },
  ...
  'contact': [
    ...
    { section_key: 'section_subtitle', content_value: 'Ready to explore the underwater world? Contact us to book your diving adventure on Nusa Lembongan.', content_type: 'textarea', label: 'Section Subtitle' },
    ...
    { section_key: 'location_line_1', content_value: 'Nusa Lembongan, Bali', content_type: 'text', label: 'Location Line 1' },
    { section_key: 'location_line_2', content_value: 'Indonesia', content_type: 'text', label: 'Location Line 2' },
  ...
  'open-water': [
    ...
    { section_key: 'price_thb', content_value: '11000', content_type: 'text', label: 'Price (IDR)' },
  ...
  'advanced': [
    ...
    { section_key: 'price_thb', content_value: '9500', content_type: 'text', label: 'Price (IDR)' },
  ...
  'rescue': [
    ...
    { section_key: 'price_thb', content_value: '10000', content_type: 'text', label: 'Price (IDR)' },
  ...
  'efr': [
    ...
    { section_key: 'price_thb', content_value: '3500', content_type: 'text', label: 'Price (IDR)' },
  ...
  'divemaster': [
    ...
    { section_key: 'price_thb', content_value: '41000', content_type: 'text', label: 'Price (IDR)' },
  ...
  'instructor': [
    ...
    { section_key: 'price_thb', content_value: '59000', content_type: 'text', label: 'Price (IDR)' },
  ...
  'discover-scuba': [
    ...
    { section_key: 'price_thb', content_value: '2500', content_type: 'text', label: 'Price (IDR)' },
  ...
  'scuba-diver': [
    ...
    { section_key: 'price_thb', content_value: '8500', content_type: 'text', label: 'Price (IDR)' },
  ...
  'discover-scuba-deluxe': [
    ...
    { section_key: 'price_thb', content_value: '5000', content_type: 'text', label: 'Price (IDR)' },
  ...
  'msdt-program': [
    ...
    { section_key: 'price_thb', content_value: '25000', content_type: 'text', label: 'Price (IDR)' },
  ...
  'fun-diving': [
    { section_key: 'fun_diving_hero_title', content_value: 'Fun Diving Nusa Lembongan', content_type: 'text', label: 'Hero Title' },
    { section_key: 'fun_diving_hero_subtitle', content_value: "Experience the best of Lembongan's underwater world with our professionally guided fun dive trips. Discover colorful coral reefs, meet amazing marine life including Mola Mola and manta rays, and make unforgettable memories.", content_type: 'textarea', label: 'Hero Subtitle' },
    { section_key: 'fun_diving_hero_cta', content_value: 'Go Fun Diving Lembongan', content_type: 'text', label: 'Hero CTA Button' },
    ...
    { section_key: 'fun_diving_world_class_body', content_value: "Beneath the turquoise water surrounding Nusa Lembongan and Nusa Penida lies a world of colorful coral reefs, teeming marine life from macro creatures to Mola Mola and if you're lucky, majestic manta rays. With over 20 captivating dive sites, there's boundless diversity to explore.", content_type: 'textarea', label: 'World-Class Sites Card Body' },
    ...
    { section_key: 'fun_diving_marine_life_body', content_value: "From magnificent Mola Mola and graceful manta rays to colorful reef fish and fascinating macro life, Lembongan's waters host an incredible variety of marine species. Every dive brings new discoveries and unforgettable encounters.", content_type: 'textarea', label: 'Marine Life Card Body' },
    ...
    { section_key: 'fun_diving_sites_title', content_value: 'Best Lembongan Fun Diving Trips', content_type: 'text', label: 'Sites Tab Title' },
  ...
  'specialty/night-diver': [
    ...
    { section_key: 'price_thb', content_value: '6500', content_type: 'text', label: 'Price (IDR)' },
  ...
  'specialty/enriched-air': [
    ...
    { section_key: 'price_thb', content_value: '4500', content_type: 'text', label: 'Price (IDR)' },
    { section_key: 'price_usd', content_value: '130', content_type: 'text', label: 'Price (USD)' },
    { section_key: 'price_eur', content_value: '120', content_type: 'text', label: 'Price (EUR)' },
    { section_key: 'duration', content_value: '1 day', content_type: 'text', label: 'Duration' },
  ],
  'specialty/underwater-photography': [
    ...
    { section_key: 'price_thb', content_value: '5500', content_type: 'text', label: 'Price (IDR)' },
  ...
  'dive-sites/sail-rock': [
    { section_key: 'hero_title', content_value: 'Crystal Bay', content_type: 'text', label: 'Hero Title' },
    { section_key: 'hero_subtitle', content_value: 'One of the best dive sites in Southeast Asia. Famous for Mola Mola sightings.', content_type: 'text', label: 'Hero Subtitle' },
  ...
  'dive-sites/chumphon-pinnacle': [
    { section_key: 'hero_title', content_value: 'Manta Point', content_type: 'text', label: 'Hero Title' },
    { section_key: 'hero_subtitle', content_value: 'A world-class dive site with massive schools of fish and regular Mola Mola sightings.', content_type: 'text', label: 'Hero Subtitle' },
  ...
  'dive-sites/japanese-gardens': [
    { section_key: 'hero_title', content_value: 'Toyapakeh', content_type: 'text', label: 'Hero Title' },
  ...
  'dive-sites/htms-sattakut': [
    { section_key: 'hero_title', content_value: 'USAT Liberty Wreck Wreck', content_type: 'text', label: 'Hero Title' },
    ...
    { section_key: 'description', content_value: 'The USAT Liberty Wreck lies at 30m and has become home to thousands of fish and spectacular soft corals.', content_type: 'textarea', label: 'Description' },
  ...
  'dive-sites/shark-island': [
    { section_key: 'hero_title', content_value: 'SD Point', content_type: 'text', label: 'Hero Title' },
  ...
  'marine-life/whale-shark': [
    { section_key: 'hero_title', content_value: 'Mola Mola', content_type: 'text', label: 'Hero Title' },
    { section_key: 'hero_subtitle', content_value: 'The ocean\'s gentle giant. Encounter the magnificent Mola Mola (Ocean Sunfish) near Nusa Lembongan.', content_type: 'text', label: 'Hero Subtitle' },
    { section_key: 'description', content_value: 'The Mola Mola (Ocean Sunfish) is the world\'s largest bony fish. Nusa Lembongan and Crystal Bay are among the best places in the world to encounter them, especially July-October.', content_type: 'textarea', label: 'Description' },
    { section_key: 'best_season', content_value: 'March – May and October – December', content_type: 'text', label: 'Best Season' },
    { section_key: 'best_sites', content_value: 'Crystal Bay, Manta Point', content_type: 'text', label: 'Best Dive Sites' },
  ],
  'marine-life/green-sea-turtle': [
    { section_key: 'hero_title', content_value: 'Green Sea Turtle', content_type: 'text', label: 'Hero Title' },
    { section_key: 'hero_subtitle', content_value: 'One of the most beloved residents of Lembongan\'s reefs.', content_type: 'text', label: 'Hero Subtitle' },
    { section_key: 'description', content_value: 'Green sea turtles are commonly spotted grazing on seagrass and resting on the reef around Nusa Lembongan.', content_type: 'textarea', label: 'Description' },
    { section_key: 'best_season', content_value: 'Year-round', content_type: 'text', label: 'Best Season' },
    { section_key: 'best_sites', content_value: 'Toyapakeh, SD Point, Hin Wong Pinnacle', content_type: 'text', label: 'Best Dive Sites' },
  ],
  'marine-life/hawksbill-turtle': [
    ...
    { section_key: 'description', content_value: 'Hawksbill turtles feed on sponges and are occasionally spotted on Lembongan\'s coral reefs.', content_type: 'textarea', label: 'Description' },
    { section_key: 'best_season', content_value: 'Year-round', content_type: 'text', label: 'Best Season' },
    { section_key: 'best_sites', content_value: 'Toyapakeh, SD Point, Twins', content_type: 'text', label: 'Best Dive Sites' },
  ],
  // INFO PAGES
  'accommodation': [
    { section_key: 'hero_title', content_value: 'Accommodation on Nusa Lembongan', content_type: 'text', label: 'Hero Title' },
  ...
  'how-to-get-here': [
    { section_key: 'hero_title', content_value: 'How to Get to Nusa Lembongan', content_type: 'text', label: 'Hero Title' },
    { section_key: 'hero_subtitle', content_value: 'Travel options from Bali (Sanur/Kusamba) by speedboat — just 30-45 minutes away.', content_type: 'text', label: 'Hero Subtitle' },
    { section_key: 'intro', content_value: 'Nusa Lembongan is accessible by ferry from Sanur or Sanur, Bali, with connecting buses, trains, and flights from Bangkok.', content_type: 'textarea', label: 'Introduction' },
  ],
  'things-to-do': [
    { section_key: 'hero_title', content_value: 'Things to Do on Nusa Lembongan', content_type: 'text', label: 'Hero Title' },
    ...
    { section_key: 'intro', content_value: 'Nusa Lembongan has plenty to offer outside of diving, from jungle hikes and stunning viewpoints to fresh seafood and sunset bars.', content_type: 'textarea', label: 'Introduction' },
  ],
  'weather': [
    { section_key: 'hero_title', content_value: 'Nusa Lembongan Weather', content_type: 'text', label: 'Hero Title' },
    { section_key: 'hero_subtitle', content_value: 'When is the best time to visit and dive at Nusa Lembongan?', content_type: 'text', label: 'Hero Subtitle' },
    { section_key: 'intro', content_value: 'Nusa Lembongan has a tropical climate with two main seasons. The best diving conditions are typically from March to September.', content_type: 'textarea', label: 'Introduction' },
