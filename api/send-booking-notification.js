  ...
  <tr><td align="center">
    <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(11,61,145,0.10);">
      ...
      <tr><td style="padding:32px;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
          <tr><td align="center">
            <a href="https://admin.lembonganwatersports.com/wp-admin/admin.php?page=ktd-dashboard" style="display:inline-block;background:linear-gradient(135deg,#0b3d91,#1a5ed4);color:#fff;text-decoration:none;padding:14px 32px;border-radius:8px;font-size:15px;font-weight:600;letter-spacing:0.5px;">Open Admin Panel →</a>
          </td></tr>
        </table>
      </td></tr>
...
function pickCustomerTemplate(payload = {}) {
  ...
  if (forced === 'received' || forced === 'reminder' || forced === 'confirmed') {
    return forced;
  }
